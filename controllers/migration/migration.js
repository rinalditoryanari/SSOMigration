...
const migrateUser = async (req, res, next) => {
    ...
    if (old_user.jabatan == 'Mahasiswa') {
        ...
        let kcGroupJurusan = kcGroupJabatan[0].subGroups.find((jurusan) => jurusan.name == old_user.jurusan);
        ...
        let kcGroupAngkatan = kcGroupJurusan.subGroups.find((angkatan) => angkatan.name == tahunAngkatan);
        ...
        * */
        ...
        let kcSubGroup = kcGroupJabatan.subGroups.find((subgroup) => subgroup.name == 'Data Migrasi');
